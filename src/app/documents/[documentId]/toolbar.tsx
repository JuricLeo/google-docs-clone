			...
			<DropdownMenuContent className="p-1 flex flex-col gap-y-1">
                {alignments.map(({ label, value, icon: Icon }) => (
                    <button
                        ...
                        className={cn(
                            "flex items-center gap-x-2 px-2 py-1 rounded-sm hover:bg-neutral-200/80",
                            editor?.isActive("textAlign", { align: value }) && "bg-neutral-200/80"
                        )}
                    >
...
export const Toolbar = () => {
	...
	return (
		<div className="bg-[#f1f4f9] px-2.5 py-0.5 rounded-[24px] m-h-[40px] flex items-center gap-0.5 overflow-x-auto">
			{sections[0].map((item) => (
